  ...
  const steps = [
    {
      ...
      description:
        "Silahkan isi formulir pendaftaran online terlebih dahulu melalui website kami.",
      icon: (
        <svg
    ...
    <section className="min-h-screen py-30 bg-gradient-to-b from-blue-50 to-white">
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
          {/* Timeline */}
          <div className="hidden md:flex items-center justify-between mb-12 md:px-8">
          ...
          <div className="md:hidden mb-8">
            <select
              ...
              className="w-full p-3 text-gray-900 rounded-lg border border-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
              value={activeStep}
            >
              {steps.map((step) => (
              ...
              <div className="md:w-2/3 p-8">
                ...
                {activeStep === 1 && (
                  <button
                    ...
                    className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg transition duration-300 cursor-pointer"
                  >
