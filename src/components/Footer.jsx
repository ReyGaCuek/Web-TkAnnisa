      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="mb-4">
              Membentuk generasi cerdas, kreatif, dan berakhlak mulia sejak
              dini.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to={"/tentang-kami"} className="hover:text-blue-300 transition">
                  Tentang Kami
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 text-center">
          <p>
            &copy; {new Date().getFullYear()} TK An-Nisa. All rights
            reserved.
          </p>
        </div>
      </div>
